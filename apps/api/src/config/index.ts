...
export const config: Config = configSchema.parse({
  ...
  jwtSecret: process.env.JWT_SECRET,
    coinbaseApiKey: process.env.COINBASE_API_KEY ?? process.env.COINBASE_CDP_API_KEY,
    coinbaseApiSecret: process.env.COINBASE_API_SECRET ?? process.env.COINBASE_CDP_API_SECRET,
    coinbaseBaseUrl: process.env.COINBASE_BASE_URL ?? process.env.COINBASE_CDP_BASE_URL,
